...
def main():
    Path(__file__).parent.parent / "test_data/World"
    ...
    ds = MatDpDB(Path(MATERIALS_EXCEL), Path(TARGETS_CSV), TARGETS_PARAMETERS)
    output = pipeline(ds, output_path=Path("/tmp/sdf"))
    print("Processed.")
